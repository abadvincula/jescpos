...
public class JescposImage {
     ...
     * @return 0 or 1
     * @see #JescposImage(BufferedImage, Bitonal)
     * @see Bitonal#getBitonalVal(BufferedImage, int, int)
     */
